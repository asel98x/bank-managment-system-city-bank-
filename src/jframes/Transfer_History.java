 ...
 * @author asel
 */
public class Transfer_History extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TransferView = new javax.swing.JTable();
        ...
        TransferView.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        TransferView.setForeground(new java.awt.Color(1, 23, 64));
        TransferView.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "AccountNo", "Transfer_Aamount", "Balance", "Credit_Account_No", "Date", "Time"
            }
        ));
        TransferView.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        TransferView.setGridColor(new java.awt.Color(234, 240, 251));
        jScrollPane1.setViewportView(TransferView);
    ...
    public void tableload(){        // to view transfer history
           try {
            ...
            dtm = (DefaultTableModel) TransferView.getModel();
    ...
    public void search(){       //to search specific holders trnsfer history
        String srch = searchBox.getText();
        
        try {
            
            String sql = "select Bank_No as AccountNo ,A_Transfer_Aamount as Transfer_Aamount, A_Balance as Balance, "
                    + "A_Credit_Bank_No as Credit_Account_No, A_date as Date,"
                    + " A_time as Time from transfer where Bank_No like '%"+srch+"%' or "
                    + "A_Credit_Bank_No like '%"+srch+"%'" ;
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            TransferView.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transfer_History.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transfer_History().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TransferView;
